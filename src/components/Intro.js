    ...
    render() {
        return (
            <div className='intro-div'>
                ...
                <p><a href="https://sites.google.com/view/jen-web" target="_blank" rel="noreferrer" className="external-link-new-window">Dr. Jennifer D'Souza</a>, a postdoc in the <a href="https://www.tib.eu/en/research-development/research-groups-and-labs/data-science-digital-libraries" target="_blank" rel="noreferrer" className="external-link-new-window">Data Science and Digital Libraries Department</a> at <a href="https://www.tib.eu/en/" target="_blank" rel="noreferrer" className="external-link-new-window">TIB</a> who currently leads the NLP development related to the ORKG has been awarded the BMBF grant for her project proposal "SciNEXT - Neural-Symbolic <u>SC</u>holarly <u>I</u>nnovatio<u>N</u> <u>EXT</u>raction". The project will be conducted in the context of the larger Open Research Knowledge Graph project and will be located at the TIB's Data Science and Digital Libraries Department. </p>
                <h5>Objectives</h5>
